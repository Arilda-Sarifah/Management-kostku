...
public class UIUtilities {
    // Color Palette - Earthy warm palette based on the provided theme
    public static final Color PRIMARY_COLOR = new Color(167, 111, 75);       // Brown
    public static final Color SECONDARY_COLOR = new Color(210, 137, 62);    // Amber
    public static final Color ACCENT_COLOR = new Color(248, 200, 118);       // Warm honey
    public static final Color DARK_BG = new Color(106, 73, 52);             // Deep brown
    public static final Color LIGHT_BG = new Color(250, 242, 228);          // Creamy background
    public static final Color CARD_BG = new Color(255, 248, 237);           // Light card
    public static final Color TEXT_PRIMARY = new Color(69, 44, 20);         // Dark chocolate
    public static final Color TEXT_SECONDARY = new Color(112, 84, 64);      // Brownish text
    public static final Color ERROR_COLOR = new Color(179, 73, 60);         // Terracotta
    public static final Color SUCCESS_COLOR = new Color(132, 158, 103);     // Soft green
    public static final Color WARNING_COLOR = new Color(217, 145, 81);      // Muted orange
    public static final Color BORDER_COLOR = new Color(222, 205, 186);      // Warm beige
    public static final Color MUTED_COLOR = new Color(203, 177, 144);       // Neutral control
    
    public static ImageIcon loadIcon(String fileName, int width, int height) {
        String[] paths = {
            "KostManagementSystem/assets/icon/" + fileName,
        ...
        if (icon == null) {
            java.net.URL resource = UIUtilities.class.getResource("/assets/icon/" + fileName);
            if (resource != null) {
    ...
    /**
     * Buat panel dengan border radius
     */
        ...
        JButton button = new JButton(text) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (getModel().isPressed()) {
                    g2.setColor(new Color(bgColor.getRed() - 30, bgColor.getGreen() - 30, bgColor.getBlue() - 30));
                } else if (getModel().isRollover()) {
                    g2.setColor(new Color(bgColor.getRed() - 10, bgColor.getGreen() - 10, bgColor.getBlue() - 10));
                } else {
                    g2.setColor(bgColor);
                }
    ...
    /**
     * Buat text field dengan desain modern
     */
    ...
    /**
     * Buat password field dengan desain modern
     */
    ...
    /**
     * Tampilkan pesan error dengan animasi
     */
